  ...
  })("lib/middleware/notFound.js", [1,3,4,5], {}, ["var logger = require(\"../logger\");","","exports.index = function(req, res, next){","  logger.error('Not Found');","  res.json(404, 'Not Found');","};"]);
_$jscmd("lib/middleware/notFound.js", "line", 1);

var logger = require("../logger");

_$jscmd("lib/middleware/notFound.js", "line", 3);

exports.index = function(req, res, next) {
    _$jscmd("lib/middleware/notFound.js", "line", 4);
    logger.error("Not Found");
    _$jscmd("lib/middleware/notFound.js", "line", 5);
